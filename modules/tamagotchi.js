...
export class Tamagotchi {
    ...
    createTamagotchi() {
        ...
        if (select === 'panda') {
            ...
            img.src = 'https://i.pinimg.com/originals/38/28/43/3828439c3927810233d4b342b7410cd2.gif'
            ...
            tamagotchiName.textContent = `${input} the ${select}`
            const img = document.createElement('img')
            img.src = 'https://pic.funnygifsbox.com/uploads/2020/08/funnygifsbox.com-2020-08-13-09-08-33-41.gif'
            img.style.width = '150px'
            img.style.height = '150px'
            tamagotchiCard.append(tamagotchiName, img, playBtn, feedBtn, happinessText, hungerText)
            tamagotchiCard.classList.add("tamagotchiCard");
